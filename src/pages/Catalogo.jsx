...
const Catalogo = () => {
  ...
  const productos = [
    ...
    { id: 17, nombre: 'Combo Artesanal 17', categoria: 'combos', imagen: '/images/producto-17.jpeg', descripcion: 'Descripción del producto 17' },
    { id: 18, nombre: 'Combo Artesanal 18', categoria: 'combos', imagen: '/images/producto-18.jpeg', descripcion: 'Descripción del producto 18' },
    { id: 19, nombre: 'Combo Artesanal 19', categoria: 'combos', imagen: '/images/producto-19.jpeg', descripcion: 'Descripción del producto 19' },
    { id: 20, nombre: 'Combo Artesanal 20', categoria: 'combos', imagen: '/images/producto-20.jpeg', descripcion: 'Descripción del producto 20' },
    { id: 21, nombre: 'Combo Artesanal 21', categoria: 'combos', imagen: '/images/producto-21.jpeg', descripcion: 'Descripción del producto 21' },
    { id: 22, nombre: 'Combo Artesanal 22', categoria: 'combos', imagen: '/images/producto-22.jpeg', descripcion: 'Descripción del producto 22' },
    { id: 23, nombre: 'Combo Artesanal 23', categoria: 'combos', imagen: '/images/producto-23.jpeg', descripcion: 'Descripción del producto 23' },
    { id: 24, nombre: 'Combo Artesanal 24', categoria: 'combos', imagen: '/images/producto-24.jpeg', descripcion: 'Descripción del producto 24' },
    
    { id: 25, nombre: 'Combo Artesanal 25', categoria: 'combos', imagen: '/images/producto-25.jpeg', descripcion: 'Descripción del producto 25' },
    { id: 26, nombre: 'Combo Artesanal 26', categoria: 'combos', imagen: '/images/producto-26.jpeg', descripcion: 'Descripción del producto 26' },
    { id: 27, nombre: 'Combo Artesanal 27', categoria: 'combos', imagen: '/images/producto-27.jpeg', descripcion: 'Descripción del producto 27' },
  ]
