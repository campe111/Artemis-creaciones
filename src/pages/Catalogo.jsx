...
const Catalogo = () => {
  ...
  const productos = [
    ...
    { id: 26, nombre: 'Combo Artesanal 26', categoria: 'combos', imagen: '/images/producto-27.jpeg', descripcion: 'Descripción del producto 26' },
    { id: 27, nombre: 'Combo Artesanal 27', categoria: 'combos', imagen: '/images/producto-28.jpeg', descripcion: 'Descripción del producto 27' },
    { id: 28, nombre: 'Combo Artesanal 28', categoria: 'combos', imagen: '/images/producto-29.jpeg', descripcion: 'Descripción del producto 28' },
    { id: 29, nombre: 'Combo Artesanal 29', categoria: 'combos', imagen: '/images/producto-30.jpeg', descripcion: 'Descripción del producto 29' },
    { id: 30, nombre: 'Combo Artesanal 30', categoria: 'combos', imagen: '/images/producto-31.jpeg', descripcion: 'Descripción del producto 30' },
    { id: 31, nombre: 'Combo Artesanal 31', categoria: 'combos', imagen: '/images/producto-32.jpeg', descripcion: 'Descripción del producto 31' },
    { id: 32, nombre: 'Combo Artesanal 32', categoria: 'combos', imagen: '/images/producto-33.jpeg', descripcion: 'Descripción del producto 32' },
  ]
